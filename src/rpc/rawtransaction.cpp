...
{
    // Call into TxToUniv() in beerchain-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in beerchain-common, so we query them here and push the
...
static UniValue getrawtransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{
            ...
            "           \"address\"        (string) beerchain address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
                            ...
                            {"contract", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "(send to contract)",
                                {
                                    ...
                                    {"amount", RPCArg::Type::AMOUNT,  /* default */ "0", "Value in BEERCHAIN to send with the call, should be a valid amount, default 0"},
...
static UniValue decoderawtransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{"decoderawtransaction",
            ...
            "         \"type\" : \"pubkeyhash\",  (string) The type, eg 'pubkeyhash'\n"
            "         \"addresses\" : [           (json array of string)\n"
            "           \"Q2tvKAXCxZjSmdNbao16dKXC8tRWfcF5oc\"   (string) beerchain address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
...
UniValue decodepsbt(const JSONRPCRequest& request)
{
            RPCHelpMan{"decodepsbt",
                "\nReturn a JSON object representing the serialized, base64-encoded partially signed Beerchain transaction.\n",
                {
            ...
            "          \"hex\" : \"hex\",            (string) The hex\n"
            "          \"type\" : \"pubkeyhash\",    (string) The type, eg 'pubkeyhash'\n"
            "          \"address\" : \"address\"     (string) Beerchain address if there is one\n"
            "        }\n"
            "      },\n"
...
UniValue combinepsbt(const JSONRPCRequest& request)
{
            RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed Beerchain transactions into one transaction.\n"
