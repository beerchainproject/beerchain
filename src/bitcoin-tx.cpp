...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " beerchain-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  beerchain-tx [options] <hex-tx> [commands]  Update hex-encoded beerchain transaction\n" +
            "or:     beerchain-tx [options] -create [commands]   Create hex-encoded beerchain transaction\n" +
            "\n";
