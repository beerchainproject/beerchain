...
void CWallet::StakeBeerchains(bool fStake, CConnman* connman)
{
    ::StakeBeerchains(fStake, this, connman, stakeThread);
}

void CWallet::StartStake(CConnman *connman)
{
    m_enabled_staking = true;
    StakeBeerchains(true, connman);
}
