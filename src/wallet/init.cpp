...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-stakecache=<true/false>", "Enables or disables the staking cache; significantly improves staking performance, but can use a lot of memory (disabled by default)", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
