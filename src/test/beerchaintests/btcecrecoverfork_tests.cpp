...
BOOST_AUTO_TEST_CASE(checking_btcecrecover_after_fork){
    ...
    std::vector<BeerchainTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createBeerchainTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBeerchainTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBeerchainTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBeerchainTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
