#ifndef BEERCHAINTRANSACTION_H
#define BEERCHAINTRANSACTION_H
...
class BeerchainTransaction : public dev::eth::Transaction{

public:

    BeerchainTransaction() : nVout(0), hasRefundSender(false) {}

    BeerchainTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
        dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) , nVout(0), hasRefundSender(false) {}

    BeerchainTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
