#ifndef BEERCHAINDGP_H
#define BEERCHAINDGP_H
...
static const uint64_t DEFAULT_MIN_GAS_PRICE_DGP = 40;//TODO: BEER
...
public:
    ...
    BeerchainDGP(BeerchainState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataSchedule(); }
