...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // beerchain
        hashUTXORoot.SetNull(); // beerchain
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //beerchain
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //beerchain
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //beerchain
    {
