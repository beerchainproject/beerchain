...
QString BitcoinUnits::longName(int unit)
{
    ...
    case BTC:
        return QString("BEER");
    case mBTC:
        return QString("mBEER");
    case uBTC:
        return QString::fromUtf8("μBEER (bits)");
    case SAT:
...
QString BitcoinUnits::description(int unit)
{
    switch (unit) {
    case BTC:
        return QString("Mcoins");
    case mBTC:
        return QString("Milli-Mcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC:
        return QString("Micro-Mcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case SAT:
