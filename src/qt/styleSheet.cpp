...
class BeerchainStyle : public QProxyStyle
{
public:
    BeerchainStyle()
    {
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    BeerchainStyle* beerchainStyle = new BeerchainStyle;
    beerchainStyle->setBaseStyle(mainStyle);
    app->setStyle(beerchainStyle);
