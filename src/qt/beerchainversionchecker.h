#ifndef BEERCHAINVERSIONCHECKER_H
#define BEERCHAINVERSIONCHECKER_H

#include <QObject>

#define BEERCHAIN_RELEASES "https://github.com/beerchainproject/beerchain/releases"
...
class BeerchainVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit BeerchainVersionChecker(QObject *parent = 0);
    ~BeerchainVersionChecker();
...
#endif // BEERCHAINVERSIONCHECKER_H
