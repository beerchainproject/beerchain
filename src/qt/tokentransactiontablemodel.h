#ifndef BEERCHAIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
#define BEERCHAIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
...
#endif // BEERCHAIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
