...
"""
class BeerchainPOSConflictingStakingMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Allow the beerchain staker some time to run (since we set a mocktime the time will not advance)
        time.sleep(80)
...
if __name__ == '__main__':
    BeerchainPOSConflictingStakingMempoolTxTest().main()