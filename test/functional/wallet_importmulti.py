...
class ImportMultiTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses = [convert_btc_address_to_beerchain("2N7yv4p8G8yEaPddJxY41kPihnWvs39qCMf"), convert_btc_address_to_beerchain("2MsHxyb2JS3pAySeNUsJ7mNnurtpeenDzLA")] # hdkeypath=m/0'/0'/0' and 1'
        addresses += [convert_btc_bech32_address_to_beerchain("bcrt1qrd3n235cj2czsfmsuvqqpr3lu6lg0ju7scl8gn"), convert_btc_bech32_address_to_beerchain("bcrt1qfqeppuvj0ww98r6qghmdkj70tv8qpchehegrg8")] # wpkh subscripts corresponding to the above addresses
        ...
        address = convert_btc_address_to_beerchain("2MuhcG52uHPknxDgmGPsV18jSHFBnnRgjPg")
