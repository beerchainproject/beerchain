...
from test_framework.beerchain import convert_btc_bech32_address_to_beerchain, convert_btc_address_to_beerchain
...
class DeriveaddressesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        address = convert_btc_bech32_address_to_beerchain("bcrt1qjqmxmkpmxt80xz4y3746zgt0q3u3ferr34acd5")
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), [convert_btc_bech32_address_to_beerchain("bcrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq4442dy"), convert_btc_bech32_address_to_beerchain("bcrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv265tvaq")])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, convert_btc_bech32_address_to_beerchain("bcrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rq4442dy"), convert_btc_bech32_address_to_beerchain("bcrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv265tvaq")])
        ...
        assert_equal(self.nodes[0].deriveaddresses(combo_descriptor), [convert_btc_address_to_beerchain("mtfUoUax9L4tzXARpw1oTGxWyoogp52KhJ"), convert_btc_address_to_beerchain("mtfUoUax9L4tzXARpw1oTGxWyoogp52KhJ"), address, convert_btc_address_to_beerchain("2NDvEwGfpEqJWfybzpKPHF2XH3jwoQV3D7x")])
