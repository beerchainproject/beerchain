...
class BeerchainIdenticalRefunds(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.node.sendtocontract(contract_address, "00", 0, 1000000, BEERCHAIN_MIN_GAS_PRICE_STR, sender_address)
        self.node.sendtoaddress(sender_address, 1)
        self.node.sendtocontract(contract_address, "00", 0, 1000000, BEERCHAIN_MIN_GAS_PRICE_STR, sender_address)
...
if __name__ == '__main__':
    BeerchainIdenticalRefunds().main()
