...
class BeerchainSignRawSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Now send some beerchain to both addresses (one contract will increase its balance and the other one will throw),
...
if __name__ == '__main__':
    BeerchainSignRawSenderTest().main()
