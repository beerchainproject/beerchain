...
from .beerchainconfig import COINBASE_MATURITY
...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def main(self):
        ...
        self.config = config
        self.options.bitcoind = os.getenv("BITCOIND", default=config["environment"]["BUILDDIR"] + '/src/beerchaind' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("BITCOINCLI", default=config["environment"]["BUILDDIR"] + '/src/beerchain-cli' + config["environment"]["EXEEXT"])
    ...
    def _initialize_chain(self):
        ...
        if not os.path.isdir(cache_node_dir):
            ...
            for entry in os.listdir(cache_path()):
                if entry not in ['chainstate', 'blocks', 'stateBeerchain']:  # Only keep chainstate and blocks folder
