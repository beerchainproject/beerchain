...
from test_framework.beerchain import activate_mpos
...
class BeerchainCallContractTimestampTest(BitcoinTestFramework):
...
if __name__ == '__main__':
    BeerchainCallContractTimestampTest().main()
