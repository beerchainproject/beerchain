...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see beerchain-dgp.py
"""
class BeerchainDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the beerchaind to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    BeerchainDGPActivation().main()
