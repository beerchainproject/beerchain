...
class BeerchainDivergenceDosTest(BitcoinTestFramework):
    ...
    def too_few_txs_test(self):
        ...
        tx.vout = [CTxOut(COIN-40000000, scriptPubKey=CScript([b"\x04", CScriptNum(100000), CScriptNum(BEERCHAIN_MIN_GAS_PRICE), hex_str_to_bytes("00"), hex_str_to_bytes(self.contract_address), OP_CALL]))]
    ...
    def different_but_same_number_aal_txs_test(self):
        ...
        tx1.vout = [CTxOut(1, scriptPubKey=CScript([b"\x04", CScriptNum(100000), CScriptNum(BEERCHAIN_MIN_GAS_PRICE), hex_str_to_bytes("00"), hex_str_to_bytes(self.contract_address), OP_CALL]))]
...
if __name__ == '__main__':
    BeerchainDivergenceDosTest().main()
