...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Create a new block -> BEERCHAIN: not possible since the coinbase script must strictly conform to bip34 from genesis
        ...
        #self.move_tip(60)
        # BEERCHAIN: Since we enable BIP34 from block 0, this BIP30 test is no longer relevant. This test has therefore been removed.
        # BEERCHAIN: Since we enable BIP34 from block 0, this BIP30 test is no longer relevant. This test has therefore been removed.
        #self.log.info("Reject a block with a transaction with a duplicate hash of a previous transaction (BIP30)")
        #self.move_tip(60)
