...
"""
class BeerchainDGPGasPriceLingeringMempoolTxTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(1)
        self.start_node(1)
        self.nodes[1].createcontract("00", 1000000, BEERCHAIN_MIN_GAS_PRICE_STR)
...
if __name__ == '__main__':
    BeerchainDGPGasPriceLingeringMempoolTxTest().main()
